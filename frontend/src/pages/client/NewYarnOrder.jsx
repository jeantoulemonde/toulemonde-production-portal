...
const local = {
  ...
  linePanel: { width: "min(920px, 100%)", maxHeight: "92vh", overflowY: "auto", background: "#fff", border: `1px solid ${T.border}`, borderRadius: 22, boxShadow: "0 28px 90px rgba(0,0,0,0.28)", padding: 22, display: "grid", gap: 18, boxSizing: "border-box" },
  detailModal: { width: "min(980px, 100%)", maxHeight: "92vh", overflowY: "auto", background: "#fff", border: `1px solid ${T.border}`, borderRadius: 22, boxShadow: "0 28px 90px rgba(0,0,0,0.28)", padding: 22, display: "grid", gap: 18, boxSizing: "border-box" },
